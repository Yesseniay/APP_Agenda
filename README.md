...
📚 Agenda Personal
    ...
    Este es un proyecto de aplicación móvil para la gestión personal que incluye tres módulos principales: Agenda de Contactos, Registro de Notas y un Calendario de Actividades interconectado con una base de datos SQLite.
...
🚀 Módulos y Funcionalidades
    ...
    1. 👥 Contactos
        ...
        CRUD:
            ...
            Editar: Se accede al formulario de edición (ItemContactoActivity.java) pulsando el botón Editar en la lista.
